...
public class EclipsePlugin extends IdePlugin {
    ...
    private final List<SourceSet> testSourceSetsConvention = new ArrayList<>();
    private final List<Configuration> testConfigurationsConvention = new ArrayList<>();
    ...
    private static void configureJavaClasspath(final Project project, final TaskProvider<GenerateEclipseClasspath> task, final EclipseModel model, List<SourceSet> testSourceSetsConvention, List<Configuration> testConfigurationsConvention) {
